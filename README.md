...
O card **PROJETO DE EFETIVO 2027–2030** reúne três subcards navegáveis e mantém os quantitativos separados: **POG + COTAM + BPTUR** (271 policiais), **RAIO** (912 policiais) e **COPAC/PReVio** (360 policiais). A seleção de um subcard abre o estudo correspondente no mesmo ambiente. Os três níveis do RAIO, as três fases do PReVio, o detalhamento do POG, a consulta por batalhão e os quadros independentes da COTAM e do BPTUR foram preservados. Não é apresentado um total geral dos três eixos, pois eles possuem escopos e premissas diferentes.
