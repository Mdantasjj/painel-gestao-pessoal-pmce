...
O card **BATALHÕES - Análise situacional de Efetivo** apresenta **1.233 policiais de necessidade consolidada apurada**: 587 da necessidade situacional dos 34 BPMs, 503 da reestruturação do interior e do litoral e 143 das unidades especializadas com movimentação individualizada. A tabela passou a reunir os 34 BPMs e 18 especializadas, com subtotais separados. A planilha por OPM contém 552 promoções requeridas detalhadas em 2025 e 215 em 2026: 430 vinculadas aos BPMs, 147 às especializadas listadas e 190 a outras OPMs. Para cada unidade com saldo disponível, **Perdas** corresponde a `máximo(0, exonerações + demissões + requeridas − saldo das movimentações)`. O 6º ao 9º BPRAIO permanece com traço no saldo e na necessidade, pois a fonte histórica de movimentações não individualiza essas denominações atuais. Os 80 processos agregados de exoneração e demissão de 2025 também não foram rateados por unidade.
