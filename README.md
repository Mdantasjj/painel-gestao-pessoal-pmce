...
O card **Análise geral efetivo dos batalhões** apresenta os 34 BPMs territoriais, classificados em 20 com ganho, 12 com perda e dois em equilíbrio nas movimentações. A subpágina mostra saldo conjunto, déficit localizado, referência da reestruturação do interior e a tabela completa por batalhão e cidades. Como o PDF de movimentações não informa o efetivo atual completo de cada unidade, o painel identifica claramente que origem, destino e saldo não equivalem ao efetivo existente.
