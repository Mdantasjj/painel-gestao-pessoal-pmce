...
| BATALHÕES - Análise situacional de Efetivo | 1.233 policiais de necessidade consolidada apurada | 587 dos 34 BPMs + 143 das especializadas com saldo individualizado + 503 da reestruturação |
...
- A mesma tabela inclui 18 unidades especializadas. Elas somam 6.457 policiais de efetivo informado, 13 exonerações e 32 demissões deduplicadas de 2026 e 147 requeridas de 2025–2026. Nas 14 unidades com movimentação individualizada, o saldo conjunto é +179 e as necessidades locais somam 143; saldos positivos não compensam necessidades de outras unidades. O 6º ao 9º BPRAIO aparece com efetivo e demais ocorrências identificadas, mas sem saldo ou necessidade calculada, pois a fonte de movimentações não os individualiza pelas denominações atuais.
