...
O card **BATALHÕES - Análise situacional de Efetivo** apresenta os 34 BPMs territoriais, classificados em 20 com ganho, 12 com perda e dois em equilíbrio nas movimentações. A subpágina mostra saldo conjunto, déficit localizado, Top 5 das maiores perdas e ganhos e uma tabela com posição, batalhão/cidades, efetivo total do batalhão, efetivo total do CRPM da região e situação média. Um painel de classificação permite ordenar interativamente por batalhão, efetivo do batalhão, efetivo do CRPM ou situação média e inverter a direção da ordem; registros sem quantitativo permanecem sempre no fim. A planilha estrutural informa o efetivo atual dos nove batalhões do interior e do litoral — 26º ao 34º BPM — e os totais dos 2º, 3º, 4º, 7º e 8º CRPM. Os campos sem cobertura documental são identificados como “Não informado”, sem estimativas. O recorte disponível soma 1.965 policiais no efetivo atual, referência agregada de 2.473,17, cobertura de 79,5% e 525 policiais necessários após converter individualmente cada necessidade em efetivo inteiro. Como o PDF de movimentações não informa o efetivo atual completo de cada unidade, o painel identifica claramente que os valores de movimentação não equivalem ao efetivo existente. Os batalhões especializados serão incorporados quando houver dados equivalentes disponíveis.
