...
- As 207 requeridas integram o total do card **PERDA DE EFETIVO** e aparecem em coluna e linha próprias na tabela por batalhão, sem distribuição territorial. A fonte não informa a unidade de origem nem confirma baixa individual; por isso, não são atribuídas a nenhum BPM nem entram no cálculo de 254. Outros 94 desligamentos administrativos pertencem a comandos, unidades especializadas e demais OPMs e não foram redistribuídos.
