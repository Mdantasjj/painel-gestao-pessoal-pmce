...
def generate_editable_powerpoint() -> None:
    ...
    add_text(slide, "●  6 indicadores", 11.96, 1.13, 0.86, 0.20, 4.7, GREEN_800, True, PP_ALIGN.CENTER)
    ...
    add_card(slide, top_x[2], "Reestruturação dos batalhões do interior e do litoral", "525", "efetivo necessário", "9 batalhões · 8 abaixo da média", OLIVE, "EDF3E4", card_width, label_size=5.5, label_height=0.30, foot_size=4.7, y=1.52, height=0.82)
    ...
    add_card(slide, bottom_x[2], "Análise geral efetivo dos batalhões", "34", "batalhões analisados", "12 com perda · 20 com ganho · 2 em equilíbrio", "145C40", "E1F1E8", card_width, label_size=6.0, label_height=0.24, foot_size=4.4, y=2.44, height=0.82)
