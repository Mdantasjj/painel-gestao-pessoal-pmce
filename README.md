...
O card **PROJETO DE EFETIVO 2027–2030** apresenta impacto total entre **1.564 e 1.603 policiais**, conforme a opção escolhida para **MARIA DA PENHA - POG**. A base de 1.543 corresponde a POG + COTAM + BPTUR (271), RAIO (912) e COPAC/PReVio (360). A escala considera uma patrulha por município, composta por três policiais, de segunda a sexta. O 1O2D abrange sete municípios, exige efetivo mínimo de 21 policiais por dia e leva o projeto a **1.564**; o 1O3D abrange 20 municípios, exige 60 policiais por dia e leva o projeto a **1.603**. As cargas semanais são, respectivamente, 105 e 300 jornadas policiais. Jornadas não representam policiais distintos; reserva técnica, férias, licenças, folgas e substituições ainda não foram incorporadas. Como os modelos são alternativos, 21 e 60 não são somados entre si.
