...
| Reestruturação dos batalhões do interior | 520,5 policiais necessários | 9 batalhões analisados: 8 abaixo da média e 1 acima; RAIO excluído |
...
- Na reestruturação do interior, nove batalhões permanecem após excluir quatro unidades do RAIO. Oito estão abaixo da média do respectivo comando; a defasagem acumulada é 520,5 e o 33º BPM — Campos Sales · Assaré apresenta a maior diferença, com 115,5.
