...
O card **PROJETO DE EFETIVO 2027–2030** apresenta o total consolidado de **1.543 policiais necessários**, correspondente à soma dos três eixos já quantificados: **POG + COTAM + BPTUR** (271 policiais), **RAIO** (912 policiais) e **COPAC/PReVio** (360 policiais). A subpágina possui quatro subcards navegáveis; o quarto é **MARIA DA PENHA - POG**, que reúne internamente as opções **PROJETO 1O2D** e **PROJETO 1O3D**. A escala considera uma patrulha por município, composta por três policiais, de segunda a sexta. O 1O2D abrange sete municípios, exige efetivo mínimo de 21 policiais por dia e gera 105 jornadas policiais semanais. O 1O3D abrange 20 municípios, exige 60 policiais por dia e gera 300 jornadas semanais. Jornadas não representam policiais distintos; reserva técnica, férias, licenças, folgas e substituições ainda não foram incorporadas. Como são opções alternativas, os dois modelos não são somados entre si nem ao total geral nesta etapa.
