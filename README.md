...
As quatro memórias de cálculo possuem o quadro transversal **Situação atual da unidade**. Um seletor permite consultar qualquer um dos 34 BPMs e relacionar efetivo, licenças saúde, média do CRPM, saídas administrativas, promoções requeridas e movimentações. O cenário de recomposição considera `movimentações − exonerações − demissões − requeridas de 2025 e 2026 vinculadas ao BPM`; o cenário operacional indicativo desconta também as licenças saúde. As demissões e exonerações estão limitadas a 2026, enquanto movimentações e requeridas abrangem 2025–2026. Promoção não é baixa da PMCE, e a planilha agregada não permite verificar repetição ou sobreposição individual entre fontes. Esses cenários não substituem o efetivo oficial nem alteram os cálculos originais dos demais projetos.
...
O card **BATALHÕES - Análise situacional de Efetivo** apresenta **587 policiais necessários à reestruturação** no cenário combinado dos 34 BPMs. A planilha por OPM contém 552 promoções requeridas detalhadas em 2025 e 215 em 2026: 430 vinculadas diretamente aos batalhões (320 + 110) e 337 a outras unidades. Para cada BPM, a tabela calcula `saldo das movimentações − exonerações − demissões − requeridas de 2025 − requeridas de 2026`. O saldo conjunto passa de +90 nas movimentações para −572 após descontar 232 saídas administrativas de 2026 e 430 requeridas dos dois anos. A soma apenas dos resultados negativos é 587 policiais em 29 batalhões; três têm saldo positivo e dois estão em equilíbrio. A coluna Requeridas mostra o total de cada BPM com a discriminação por ano, permite ordenação e mantém as 337 requeridas externas em linha separada. A base de efetivo cobre os 34 BPMs e oito CRPMs, totalizando 9.956 policiais.
...
O card **PERDA DE EFETIVO** apresenta **1.095 registros considerados**: 245 demissões e 83 exonerações de 2026, além de 767 promoções requeridas de 2025–2026. A base administrativa contém 340 lançamentos, dos quais 12 são duplicados, restando 328 saídas confirmadas. A aba de 2025 contém 552 registros detalhados — 458 acessos ao oficialato e 94 promoções de oficiais —, embora sua célula “TOTAL 458” some apenas a seção de subtenentes. A aba de 2026 contém 215. No recorte dos BPMs, são 662 impactos contabilizados (232 saídas administrativas + 430 requeridas), sem comprovação de pessoas únicas ou baixas institucionais. Os períodos das fontes diferem. O visualizador **Reconciliação da base de saídas** continua retirado; metodologia e ressalvas estão no estudo.
