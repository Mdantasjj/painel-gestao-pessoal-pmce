...
No card principal, **POG** é apresentado como **Policiamento Ostensivo Geral (atendimento de ocorrências e maior visibilidade à sociedade)**. A explicação foi retirada do texto introdutório da subpágina para evitar repetição.
