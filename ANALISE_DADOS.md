...
| BATALHÕES - Análise situacional de Efetivo | 1.256 policiais de necessidade consolidada apurada | 587 dos 34 BPMs + 166 das especializadas com saldo individualizado + 503 da reestruturação |
...
- A mesma tabela inclui 19 unidades especializadas. Elas somam 6.831 policiais de efetivo informado, 13 exonerações, 45 demissões deduplicadas de 2026 e 151 requeridas de 2025–2026. Nas 15 unidades com movimentação individualizada, o saldo conjunto é +173 e as necessidades locais somam 166; saldos positivos não compensam necessidades de outras unidades. A COPAC acrescenta 374 policiais, 13 demissões, quatro requeridas, saldo de movimentações de −6 e necessidade situacional de 23. O 6º ao 9º BPRAIO aparece com efetivo e demais ocorrências identificadas, mas sem saldo ou necessidade calculada, pois a fonte de movimentações não os individualiza pelas denominações atuais.
