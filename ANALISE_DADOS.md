...
- `DISTRI VTR (1).xlsx` — SHA-256 `5BC0B6767E532ACBFDBBE8948B15BD18047FA1005565A20BACA990ACC0B0561A`. A aba `BASE` foi utilizada exclusivamente para relacionar BPM/CRPM aos municípios e ao campo `area_km2`. A planilha não contém uma coluna formal de sede; por isso, o painel apresenta o município de maior área vinculado a cada BPM e até três municípios distintos de maior área para cada CRPM, sem rótulo adicional. Os 1º e 5º CRPMs possuem apenas Fortaleza como município distinto na fonte analisada.
