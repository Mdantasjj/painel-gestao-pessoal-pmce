...
const metricDetails = {
  ...
  battalions: {
    ...
    tableColumns: ['Posição', 'Batalhão / cidades', '<span class="column-title-line">Efetivo do</span><span class="column-title-line">batalhão</span>', 'Exonerações · outros concursos', 'Demissões · outros concursos', 'Requeridas', 'Movimentações', '<span class="column-title-line">Reestruturação</span><span class="column-title-line">interior e litoral</span>', 'Necessidade de efetivo'],
    tableRows: [],
    battalionTotals: {
