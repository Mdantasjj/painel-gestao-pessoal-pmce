...
O card **BATALHÕES - Análise situacional de Efetivo** apresenta **1.090 policiais de necessidade consolidada**: 587 da necessidade situacional dos 34 BPMs mais 503 da reestruturação do interior e do litoral. A planilha por OPM contém 552 promoções requeridas detalhadas em 2025 e 215 em 2026: 430 vinculadas diretamente aos batalhões (320 + 110) e 337 a outras unidades. Nos 34 BPMs, exonerações, demissões e requeridas somam 62 + 170 + 430 = **662 ocorrências brutas**. Para cada BPM, **Perdas** aparece depois de **Movimentações** e corresponde a `máximo(0, exonerações + demissões + requeridas − saldo das movimentações)`. Dessa forma, entradas reduzem a perda local, saídas por movimentação a ampliam e saldos positivos de uma unidade não compensam perdas de outra; a soma das perdas locais é **587**. A penúltima coluna acrescenta os números da reestruturação ao 26º–34º BPM e mostra “—” nos demais. A última coluna soma as duas parcelas por unidade. A base de efetivo cobre os 34 BPMs e oito CRPMs, totalizando 9.956 policiais.
