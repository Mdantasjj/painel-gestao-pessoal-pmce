...
O card **PROJETO DE EFETIVO 2027–2030** apresenta o total consolidado de **1.543 policiais necessários**, correspondente à soma dos três eixos já quantificados: **POG + COTAM + BPTUR** (271 policiais), **RAIO** (912 policiais) e **COPAC/PReVio** (360 policiais). A subpágina possui quatro subcards navegáveis; o quarto é **MARIA DA PENHA - POG**, que reúne internamente as opções **PROJETO 1O2D** e **PROJETO 1O3D**. O 1O2D tem sete municípios cadastrados: Barbalha, Crato, Itaitinga, Quixeramobim, Nova Russas, Pacatuba e Juazeiro do Norte. O 1O3D tem 20 municípios cadastrados: Aquiraz, Barbalha, Boa Viagem, Crato, Eusébio, Granja, Ipu, Itaitinga, Limoeiro do Norte, Missão Velha, Nova Russas, Quixeramobim, Pacajus, Pacatuba, Paracuru, Russas, São Benedito, São Gonçalo do Amarante, Viçosa do Ceará e Juazeiro do Norte. Nenhuma das duas opções altera o total enquanto os quantitativos de efetivo não forem fornecidos.
