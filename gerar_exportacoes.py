...
def generate_editable_powerpoint() -> None:
    ...
    add_card(slide, top_x[1], "Déficit de efetivo — POG — Policiamento Ostensivo Geral", "111", "policiais", "Atendimento de ocorrências e maior visibilidade à sociedade", "216F4C", "E4F2E9", card_width, label_size=6.2, label_height=0.22, foot_size=4.5, y=1.52, height=0.82)
