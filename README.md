...
O card **PROJETO DE EFETIVO 2027–2030** apresenta o total consolidado de **1.543 policiais necessários**, correspondente à soma dos três eixos já quantificados: **POG + COTAM + BPTUR** (271 policiais), **RAIO** (912 policiais) e **COPAC/PReVio** (360 policiais). A subpágina possui agora cinco subcards navegáveis: os três estudos quantificados, **PROJETO 1O2D** e **PROJETO 1O3D**. Os dois novos projetos permanecem identificados como em estruturação e não alteram o total enquanto seus dados e memórias de cálculo não forem fornecidos.
