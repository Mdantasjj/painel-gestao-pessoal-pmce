...
O primeiro dos seis cards apresenta **232 saídas de efetivo vinculadas aos 34 batalhões**: 170 demissões e 62 exonerações. Esse número utiliza a mesma abrangência da análise situacional dos BPMs. A subpágina reconcilia a fonte geral: 340 registros consolidados, dos quais 12 são duplicidades, dois não possuem detalhamento nominal extraível, 94 pertencem a comandos, unidades especializadas e demais OPMs e 232 integram o recorte territorial validado. As aposentadorias foram retiradas deste indicador por enquanto. Os demais cards mantêm as necessidades de efetivo do RAIO, do COPAC/PReVio, da reestruturação dos batalhões do interior e do litoral, o indicador consolidado do POG com a implementação da Companhia Pronta-Resposta (COTAM) e da 6ª Cia/BPTUR, e a análise situacional de efetivo dos batalhões.
