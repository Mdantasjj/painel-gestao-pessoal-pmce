...
def generate_editable_powerpoint() -> None:
    ...
    add_card(slide, top_x[2], "Reestruturação dos batalhões do interior", "520,5", "efetivo necessário", "9 batalhões · 8 abaixo da média", OLIVE, "EDF3E4", card_width, label_size=6.2, label_height=0.22, foot_size=4.7, y=1.52, height=0.82)
